      ...
      <div className={`App`}  style={{background:`linear-gradient(170deg, ${settings.bg_body}4D, #fff 40%, #fff 50%, #fff 65%, ${settings.bg_body})`}}>
        ...
        <main>
          ...
          <div className='mx-2 padding-t9'>
            ...
            <Row className='shaddow1 rad15 mx-2 bg-white'>
              ...
              <Col md={10} sm={12}>
                <p className='textsize24 text-left font_weight700 mb-1' style={{color:settings.color_title}}>Artikel Opendata</p>
                <p 
                ...
                <p 
                  className={`text-white px-5 py-2 rad10 textsize12`}
                  style={{backgroundColor:settings.bg_title}}
